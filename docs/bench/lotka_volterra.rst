...
.. literalinclude:: ../../bench/diffeq_lotka_volterra.jl
   :encoding: latin-1
   :language: julia
...
The Diffsol and DifferentialEquations.jl implementations of the TSIT45 method perform the best across all tolerances and both hardware setups, 
with the Diffsol implementation being consistently faster, especiall at lower tolerances. Diffrax's Tsit5 implementation is slower, perhaps due to the use of double precision
