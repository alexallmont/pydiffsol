...
def bench(ngroups, tols):
    ...
    for ng in ngroups:
        for tol in tols:
            ...
            def diffrax():
                return diffrax_bench(
                    diffrax_model, ngroups=ng, t_final=t_final, tol=tol
                )
            ...
            diffsol_esdirk34_model = diffsol_setup(
                ngroups=ng, tol=tol, method="esdirk34"
            )
...
if __name__ == "__main__":
    bench(ngroups=[1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048], tols=[1e-8])
