...
// Private method used by generate_pyi.py in CI.yml to make autocomplete file
#[pyfunction]
fn _generate_pyi() -> PyResult<()> {
    // `stub_info` generated by `define_stub_info_gatherer!` above
    let stub = crate::stub_info().map_err(|e| PyRuntimeError::new_err(e.to_string()))?;
